...
| OrbStack `ece-dev` | Ubuntu 26.04 LTS, arm64. Git 2.53.0, Verilator 5.032, Python 3, CMake 4.2.3, and `riscv64-unknown-elf-gcc` 14.2 are present. Official Spike 1.1.0 with commit logging was built at pinned commit `530af85d83781a3dae31a4ace84a573ec255fefa` under ignored `build/tools/spike`. Icarus Verilog, Yosys, Vivado, QEMU RISC-V, and Ninja were not found on the current PATH. |
